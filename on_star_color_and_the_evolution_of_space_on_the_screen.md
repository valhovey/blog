...
{:refdef: style="display:flex;align-items:center;flex-direction:column;"}
![The Hertzsprung-Russell Diagram plotting stellar luminosity against effective temperature.](/blog/images/on_star_color_and_the_evolution_of_space_on_the_screen/hr_diagram.png)
{:refdef}
...
{:refdef: style="display:flex;align-items:center;flex-direction:column;"}
![Red Dead Redemption 2's night sky portraying the Milky Way as a brown band with monochromatic stars.](/blog/images/on_star_color_and_the_evolution_of_space_on_the_screen/red_dead_redemption_night_sky.jpg)
{:refdef}
...
{:refdef: style="display:flex;align-items:center;flex-direction:column;"}
![A still from Interstellar showing space rendered as nearly empty and black behind the spacecraft.](/blog/images/on_star_color_and_the_evolution_of_space_on_the_screen/interstellar_space.jpg)
{:refdef}
...
{:refdef: style="display:flex;align-items:center;flex-direction:column;"}
![A still from The Martian showing space depicted as dark and largely starless.](/blog/images/on_star_color_and_the_evolution_of_space_on_the_screen/the_martian_space.jpg)
{:refdef}
